...
define(['jquery', 'backbone', 'underscore', 'pixi', '../card_collection', '../cards/InfoCardModel', '../cards/CardBossModel', '../EventsConfig'], function ($, Backbone, _, pixi, CardCollection, InfoCardModel, CardBossModel, Events) {
